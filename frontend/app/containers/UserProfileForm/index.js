...
export class UserProfileForm extends React.Component { // eslint-disable-line react/prefer-stateless-function
            ...
            <Spin spinning={this.props.userProfileForm.ui.getUserProfilePending}>
              <Form onSubmit={this.handleSubmit}>
                <FormItem {...formItemLayout} label="First Name" hasFeedback>
                  {
                    this.generateFieldDecorator('first_name', requiredRule(), (
                      <Input type="text" />
                    ))
                  }
                </FormItem>
                <FormItem {...formItemLayout} label="Last Name" hasFeedback>
                  {
                    this.generateFieldDecorator('last_name', requiredRule(), (
                      <Input type="text" />
                    ))
                  }
                </FormItem>
                <FormItem {...formItemLayout} label="Email" hasFeedback>
                  {
                    this.generateFieldDecorator('email', requiredRule(), (
                      <Input type="text" />
                    ))
                  }
                </FormItem>
                <FormItem {...formItemLayout} label="Mobile" hasFeedback>
                  {
                    this.generateFieldDecorator('mobile_number', requiredRule(), (
                      <Input type="text" />
                    ))
                  }
                </FormItem>
                <FormItem {...formItemLayout} label="Organization" hasFeedback>
                  {
                    this.generateFieldDecorator('organization', requiredRule(), (
                      <Input type="text" />
                    ))
                  }
                </FormItem>
...
const WrappedUserProfileForm = Form.create({
  mapPropsToFields: (props) =>
    _.reduce(props.userProfileForm.data.userProfile, (memo, value, key) => {
